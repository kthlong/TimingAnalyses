function distmat = cstClassification_meanreps_speed(data,data_test,distancemetric,varDim,repDim,minT,maxT,qval)
...
testdata_reshaped(1,:,:,:,:,:,:) = permute(data_test,[varDim repDim allotherdims]);
testMatrix = permute(repmat(testdata_reshaped,nCategories,1,1,1,1,1,1),[2 1 3 4 5 6 7 8]);
